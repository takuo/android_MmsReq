...
public class MMSReq extends Activity {
    ...
    class AsyncRequest extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            setTextMessage(mMessage+ ": " + df.format(new Date()));
        }
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setMessage(getString(R.string.start_request));
    ...
    public String requestMMS() {
        ...
        try {
            ...
            HttpGet req = new HttpGet(MMS_URL);
 ...
 */
    ...
    private void ensureRoute(ConnectivityManager ConnMgr) throws IOException {
